...
**Memory Game** is an app that challenges users to match pairs of emoji cards. The cards start face-down and can be flipped over to reveal emojis. If two selected cards match, they disappear. 
